...
from realtime_interview_agent.llm import generate_followup
from realtime_interview_agent.nlu import analyze_answer
...
def main() -> None:
    ...
    asked_questions: list[str] = [QUESTION]
    ...
    for turn in range(TURNS):
        ...
        signals = analyze_answer(transcript)
